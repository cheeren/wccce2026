...
::: {.fragment}
[**No kinship**]{.purple} — they don't feel the room needs them.
...
::: {.fragment}
[**Structural design**]{.purple} — presence as a epistemologic necessity in learning activities
:::

::: {.fragment}
[**Making the invisible cost visible**]{.orange} — make sure community values are transparent
:::
...
::: {.fragment}
[**Pre-commitment**]{.yellow} — students declare why being in the room matters, refer to it often
:::
...
::: {.fragment}
[**Recording as precondition**]{.blue} — absence must be a choice, not a constraint
:::
...
::: {.fragment}
[**Knowledge reciprocity**]{.purple} — example: students document bugs and fixes in a shared classroom knowledge base. Their insights sustain everyone else's progress.
:::

::: {.fragment style="margin-top: 0.6em;"}
[**Peer mentorship by visiting**]{.orange} — example: students move between groups to listen and support. The goal is presence and connection.
:::

...
I know this is close because my own student/kid said, "this is very me coded."
...
::: {.notes}
This is the imperative. Not better content delivery -- we no longer have the monopoly on that. But something a 1:1 interaction structurally cannot produce.

(Jotto, and the ensuing discussion of decision trees is an example.)

"All of this. None of it happens 1:1. None of it happens with a tutor. These are the things we can offer that nothing else can — and they all run counter to the isolation of individual learning."
...
Also, after all this time together, we know who likes what kinds of puzzles! (Well, Ellen can do all of them, but she's really patient with the rest of us.)
...
[**Collective intelligence**]{.purple} allows groups to outperform individuals on many tasks. &emsp; *(Woolley et al., 2010, Science)*

Learning emerges through participation in [**communities of practice**]{.orange}. &emsp; *(Lave & Wenger, 1991)*

[**Cognitive division of labor**]{.green} in groups reduces individual load and supports flexible thinking. &emsp; *(Wegner, 1987)*
...
Prepared anchors: Euler's Formula (#14) and Candy Hearts (#1). Voronoi (#11) is available but not the default — it's strong on sensory design, weaker on community dependency.
:::
...
<div style="background: white; border-radius: 8px; padding: 1.2em 3em; box-shadow: 0 4px 20px rgba(0,0,0,0.3); text-align: left; min-width: 600px;">
<div style="font-family: 'Quicksand', sans-serif; font-size: 3em; font-weight: 700; color: #825a9b; line-height: 1.2;">A: &emsp;&emsp;&emsp;&emsp;&emsp;<br>B: &emsp;&emsp;&emsp;&emsp;&emsp;<br>C: &emsp;&emsp;&emsp;&emsp;&emsp;</div>
</div>
</div>
...
1. [**Acknowledge the canonical treatment**]{.purple} — *give them the starting place for independent study*

2. [**Situate in an authentic, motivating context**]{.orange} — *find something delightful*

3. [**Design for active knowledge construction**]{.green} — *don't tell them anything, let them speculate*

4. [**Make structure perceptible**]{.yellow} — *illuminate a metaphor, or make things sensory*

5. [**Culminate in authentic production**]{.red} — *nurture their ability to build things*
...
[**Curiosity**]{.purple} enhances memory encoding. &emsp; *(Gruber et al., 2014, Neuron)*


[**Teacher enthusiasm**]{.orange} is associated with increased student engagement and enjoyment. &emsp; *(Frenzel et al.)*


[**Metaphors**]{.green} support understanding by mapping structure between domains. &emsp; *(Gentner, 1983)*


[**Authentic, real-world tasks**]{.yellow} often increase student motivation. &emsp; *(PBL meta-analyses, 2024)*
...
::: {.notes}
This is our next puzzle. I'd like to facilitate a discussion where we solve it together!
:::
...
[**Physical barriers**]{.blue} — commutes or jobs.

[**Overconfidence**]{.green} — they believe they can catch up.

[**Present bias**]{.orange} — immediate vs. delayed gratification. A volleyball game with friends is more appealing in the moment, and the cost of missing class is invisible.

[**No kinship**]{.purple} — they don't feel the community needs them, or that they belong.
...
The minute they hit the threshold, attendance died. Like, immediately. Deci and Ryan could have told me that. External rewards erode the very motivation you're trying to encourage.
...
::: {.fragment}
[**Structural design**]{.purple} — presence as a epistemological necessity in learning activities
:::

::: {.fragment}
[**Making the hidden cost visible**]{.orange} — make sure community values are transparent
:::

::: {.fragment}
[**Social accountability**]{.green} — create subgroups who expect to see them
:::

::: {.fragment}
[**Pre-commitment**]{.yellow} — on day 1 students declare why being in the room matters, refer to it often
:::

::: {.fragment}
[**Attendance Chart**]{.magenta} — Christine Goedhart's daily reflection and physical evidence
:::

::: {.fragment}
[**Recording is a given**]{.blue} — equity and accessibility
:::
...
Structural design: "I think this one actually works."
...
1. What's missing from these ideas?
2. What's working for you? What gets students to show up, and stay engaged?
3. What have you tried that *didn't* work?
4. What are your ideas for innovation?
:::

![](QR\ Code\ for\ Solving\ Attendance.png){fig-align="center" height="200"}
...
<iframe src="https://app.sli.do/event/4fZg6m7B9swXjJEoFns7qe" height="100%" width="100%" frameBorder="0" style="min-height: 560px;" allow="clipboard-write" title="Slido"></iframe>
...
::: {style="text-align: center; font-size: 1.4em; padding-top: 2em; line-height: 1.5;"}
[Everything I know about teaching,]{.yellow}

[I learn at Puzzled Pint,]{.yellow}

[and the puzzles are never the point.]{.orange}
...
The reveal pacing matters: the title of the talk is a setup. The middle line is the truth. The last line is the meaning. Let each fragment land before the next.
...
## References {style="font-size: 0.4em;"}
...
::: {.notes}
Real bibliography. Don't read it aloud — just have it up while taking questions, and it serves as the lasting handout if anyone wants to follow up later.
:::
